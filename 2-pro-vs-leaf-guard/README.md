# 2.0 PRO® vs. LeafGuard — design reference
...
- `VsLeafGuard.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `VsLeafGuard.dc.html`;
