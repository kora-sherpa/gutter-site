# 2.0 PRO® vs. LeafFilter — design reference
...
- `VsLeafFilter.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `VsLeafFilter.dc.html`;
