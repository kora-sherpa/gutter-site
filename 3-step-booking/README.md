# Booking — 3-Step Estimate Form — design reference
...
- `Booking.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Booking.dc.html`;
