# Service Detail — 2.0 PRO® Installation — design reference
...
- `ServiceDetail.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `ServiceDetail.dc.html`;
